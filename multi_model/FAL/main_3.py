...
if __name__ == '__main__':
    ...
    model = FAL(configs_audio,configs_text,configs_fusion).to(config_exp["device"])
    ...
    for ep in range(1, config_exp['epochs']):
        ...
        if best_f1_score>0.9:
            torch.save(model,os.path.dirname(os.path.dirname(os.getcwd()))+"/models_3/FAL_models/fuse-"+str(np.round(best_f1_score,2))+"-"+str(1))